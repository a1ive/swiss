...

{
    ...
    while ((LineA < FileA->LineCount) || (LineB < FileB->LineCount)) {
        ...
        if ((LineA < FileA->LineCount) &&
            ...
            if (SizeA == 1) {
                printf("%lld", (LONGLONG)LineA + 1);

            } else {
                printf("%lld,%lld", (LONGLONG)LineA + 1, (LONGLONG)LineA + SizeA);
            }
            ...
            if (SizeB == 1) {
                ...
                printf("c%lld,%lld\n", (LONGLONG)LineB + 1, (LONGLONG)LineB + SizeB);
            }
        ...
        //
            ...
            if (SizeA == 1) {
                ...
                printf("%lld,%lldd%lld\n", (LONGLONG)LineA + 1,
                (LONGLONG)LineA + SizeA, (LONGLONG)LineB);
            }
        ...
        //
            ...
            if (SizeB == 1) {
                printf("%llda%lld\n", (LONGLONG)LineA, (LONGLONG)LineB + 1);
...

{
    ...
    while ((LineA < FileA->LineCount) || (LineB < FileB->LineCount)) {
        ...
        if (SizeA <= 1) {
            printf("*** %lld ***\n", (LONGLONG)LineA + (((LONGLONG)LineA + SizeA) != 0));

        } else {
            printf("*** %lld,%lld ***\n", (LONGLONG)LineA + 1, (LONGLONG)LineA + SizeA);
        }
...

{
    ...
    while ((LineA < FileA->LineCount) || (LineB < FileB->LineCount)) {
        ...
        if (SizeA == 0) {
            printf("@@ -%lld,0 ", (LONGLONG)LineA + (LineA != 0));

        } else if (SizeA == 1) {
            printf("@@ -%lld ", (LONGLONG)LineA + 1);

        } else {
            printf("@@ -%lld,%lld ", (LONGLONG)LineA + 1, (LONGLONG)SizeA);
        }

        if (SizeB == 0) {
            printf("+%lld,0 @@\n", (LONGLONG)LineB + (LineB != 0));

        } else if (SizeB == 1) {
            printf("+%lld @@\n", (LONGLONG)LineB + 1);

        } else {
            printf("+%lld,%lld @@\n", (LONGLONG)LineB + 1, (LONGLONG)SizeB);
        }
